...
class Dataset_ETT_hour(Dataset):
    ...
    def __read_data__(self):
        ...
        df_stamp = df_stamp.set_index('datetime')
        ...
        if self.timeenc == 0:
            ...
            data_stamp = time_features(df_stamp.index, freq=self.freq)
...
class Dataset_Custom(Dataset):
    ...
    def __read_data__(self):
        ...
        border1 = border1s[self.flag == 'train' and 0 or self.flag == 'val' and 1 or 2]
        border2 = border2s[self.flag == 'train' and 0 or self.flag == 'val' and 1 or 2]
        
        if self.features == 'M' or self.features == 'MS':
            cols_data = ['people', 'weather', 'event']  
            df_data = df_raw[cols_data]
        elif self.features == 'S':
            df_data = df_raw[[self.target]]
